Since I need to use SQLite to query the Pi-hole database, I may as well keep some of the most common commands handy.
...
| Tables matching a pattern | .tables ?PATTERN? |
| Schema of a table | .schema TABLENAME |

---


## Contents of ".help", for SQLite3:
```
